...
public class UniversalDoor : MonoBehaviour
{
    ...
    [Tooltip("Should the doors automatically open when in trigger range? Or should " +
    ...
    [SerializeField, Tooltip("Reflects whether or not the door is currently open")]
    private bool isOpen = false;

    [SerializeField, Tooltip("Shows the speed at which the door is delayed before closing")]   
